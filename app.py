...
def grad_descent(X_new, X1, Y1, Z1, q, b, c, eps=0.05, precision=0.0001, max_iter=200, n=2):
    X_old = np.zeros((1, 2))
    X_new = np.zeros((1, 2))
    dfr = np.zeros((1, 2))
    X_new[0][0] = 4.9
...
def gradient_descent():
    ...
    Z1 = f(X_new, q, b, c)
    x_list, y_list = grad_descent(X_new, X1, Y1, Z1, q, b, c, eps, precision, max_iter)
