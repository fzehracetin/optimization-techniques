...
This repository will comprise primary optimization algorithms implementations in Python language. These algorithms based on Gradient Descent Algorithm. You can try this algorithms on my [Heroku app](https://optimization-algorithms.herokuapp.com/).
